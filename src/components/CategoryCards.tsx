...
const categories = [{
  ...
  tests: [{
    name: "ASP.NET Core Foundations",
    description: "Learn ASP.NET Core fundamentals"
  }, {
    name: "ASP.NET MVC with Web API",
    description: "Build MVC applications with Web API"
  }, {
    name: ".NET Design Patterns",
    description: "Master design patterns in .NET"
  }, {
    name: ".NET Microservices",
    description: "Build microservices with .NET"
  }],
  count: 12,
  ...
  tests: [{
    ...
    description: "Master SQL Server fundamentals"
  }, {
  ...
  tests: [{
    name: "ReactJS Foundations",
    description: "Build modern React applications"
  }, {
    name: "Angular Foundations",
    description: "Complete Angular development"
  }, {
  ...
  return <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Choose Your Skill Challenge</h2>
        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
          ...
          <TabsContent value="all">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              return <Card key={category.name} className={`${category.bgColor} border-0 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group cursor-pointer`}>
                    ...
                    <CardContent className="pt-0">
                      <div className="flex gap-2">
                        <Button className={`flex-1 bg-gradient-to-r ${category.color} hover:opacity-90 text-white`} onClick={() => setSelectedTab(category.id)}>
                          View Tests
          ...
          {categories.slice(1).map(category => <TabsContent key={category.id} value={category.id}>
              <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6">
                {category.tests.map((test, index) => {
              const Icon = category.icon;
              return <Card key={index} className={`${category.bgColor} border-0 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group cursor-pointer`}>
                      <CardHeader className="pb-4">
